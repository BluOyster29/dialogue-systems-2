...
get_temperature = ss (("the temperature"));
get_temperature_resolve_ynq_1 = resolve_ynq get_temperature;
get_temperature_user_question_2 select_city = ss ("what is the temperature of " ++ select_city.s);
get_temperature_user_question_3 select_city select_country = ss ("what is the temperature of " ++ select_city.s ++ " in " ++ select_country.s ++ " number");
