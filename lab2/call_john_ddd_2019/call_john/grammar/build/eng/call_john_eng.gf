...
make_call_request_1 contact_name = ss ("call " ++ contact_name.s);
make_call_request_2 contact_name number_type = ss ("call " ++ contact_name.s ++ "'s " ++ number_type.s);
...
mobile = ss (("mobile"));
home = ss (("home"));
contact_mary = ss ((("" ++ CAPIT ++ "mary")));
work = ss (("work"));
contact_john = ss ((("" ++ CAPIT ++ "john")));
...
select_contact = ss "which contact";
