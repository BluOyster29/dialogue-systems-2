...
contact_lookup_user_question_3 select_contact select_number = ask_whq contact_lookup select_contact select_number;
contact_lookup_user_question_4 select_contact = ask_whq contact_lookup select_contact;
...
report_ended_MakeCall_5 select_contact select_number = report_ended "MakeCall" (list select_contact select_number);
report_failed_MakeCall_undefined_failure_6 select_contact select_number = report_failed "MakeCall" (list select_contact select_number) "undefined_failure";
PhoneNumberAvailable_7 select_contact = rejectICM (set (list select_contact)) "PhoneNumberAvailable";
}
