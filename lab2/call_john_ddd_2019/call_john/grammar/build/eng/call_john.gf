...
contact_lookup_resolve_ynq_3 : SysResolveGoal;
ask_contact_lookup : UsrWHQ;
contact_lookup_user_question_4 : Predicate_select_contact -> Predicate_select_number -> UsrWHQ;
contact_lookup_user_question_5 : Predicate_select_contact -> UsrWHQ;
...
report_ended_MakeCall_6 : SysAnswer -> SysAnswer -> SysReportEnded;
report_failed_MakeCall_undefined_failure_7 : SysAnswer -> SysAnswer -> SysReportFailed;
PhoneNumberAvailable_8 : SysAnswer -> SysICM;
}
